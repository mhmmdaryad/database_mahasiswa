...
public class konfigurasi {
    ...
    public static final String URL_ADD = "http://192.168.1.9/datamobile/insert.php";
    public static final String URL_GET_ALL = "http://192.168.1.9/datamobile/read.php";
    public static final String URL_GET_MHS = "http://192.168.1.9/datamobile/select.php?id=";
    public static final String URL_UPDATE_MHS = "http://192.168.1.9/datamobile/update.php";
    public static final String URL_DELETE_MHS = "http://192.168.1.9/datamobile/delete.php?id=";
